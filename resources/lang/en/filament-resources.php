...
return [
    ...
    'survey-form-group-fields' => [
        ...
        'lock_heading' => __('Lock Form Fields'),
        'lock_description' => __('Locking the fields prevents them from being changed after entries have been submitted.'),
        'unlock_heading' => __('Unlock Form Fields'),
        'unlock_description' => __('Changing fields after entries have been submitted can cause inconsistencies in existing responses.'),
        'fields' => [
            'type' => __('Type'),
            'label' => __('Label'),
            'options' => __('Options'),
            'options_placeholder' => __('Add options'),
            'options_hint' => __('Press Enter after adding each option.'),
            'hint' => __('Hint'),
            'heading' => __('Heading'),
    ...
    'survey-form' => [
        ...
        'pdf' => [
            'average' => [
                ...
                'responses_per_registered' => __('responses out of registered'),
            ],
            'responses' => [
