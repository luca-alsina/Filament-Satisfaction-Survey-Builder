...
return [
    ...
    'survey-form-group-fields' => [
        ...
        'lock_heading' => __('Verrouiller les questions'),
        'lock_description' => __('Le verrouillage empêche toute modification des questions après l’envoi de réponses.'),
        'unlock_heading' => __('Déverrouiller les questions'),
        'unlock_description' => __('Modifier les questions après l’envoi de réponses peut créer des incohérences dans les réponses existantes.'),
        'fields' => [
            'type' => __('Type'),
            'label' => __('Libellé'),
            'options' => __('Options'),
            'options_placeholder' => __('Ajouter des options'),
            'options_hint' => __('Appuyez sur Entrée après chaque option.'),
            'hint' => __('Indice'),
            'heading' => __('Titre'),
